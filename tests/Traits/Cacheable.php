...
trait Cacheable
{
    ...
    public function test_it_can_add_and_retrieve_an_item(): void
    {
        $this->assertTrue($this->stash->put('put', 'jabberwocky', 5));
        $this->assertEquals('jabberwocky', $this->stash->get('put'));
    }

    public function test_it_can_override_a_preexisting_item(): void
    {
    ...
    public function test_it_can_add_and_retrieve_an_item_forever(): void
    {
    ...
    public function test_it_returns_false_for_an_expired_item(): void
    {
    ...
    public function test_it_returns_false_for_nonexistant_items(): void
    {
    ...
    public function test_it_remembers_an_already_cached_item(): void
    {
    ...
    public function test_it_remembers_an_already_cached_boolean_false(): void
    {
    ...
    public function test_it_remembers_a_nonexistant_item(): void
    {
    ...
    public function test_it_remembers_an_already_cached_item_forever(): void
    {
    ...
    public function test_it_remembers_a_nonexistant_item_forever(): void
    {
    ...
    public function test_it_can_increment_an_item(): void
    {
    ...
    public function test_it_can_increment_an_item_by_a_custom_ammount(): void
    {
    ...
    public function test_it_can_decrement_an_item(): void
    {
    ...
    public function test_it_can_decrement_an_item_by_a_custom_ammount(): void
    {
    ...
    public function test_it_returns_false_when_incrementing_a_nonexistant_item(): void
    {
        $this->assertFalse($this->stash->increment('nonexistant-item'));
    }

    public function test_it_returns_false_when_decrementing_a_nonexistant_item(): void
    {
        $this->assertFalse($this->stash->decrement('nonexistant-item'));
    }

    public function test_it_can_set_a_new_expiration_time_for_an_item(): void
    {
    ...
    public function test_it_sets_an_item_to_false_when_touchng_a_nonexistant_item(): void
    {
    ...
    public function test_it_can_set_a_new_expiration_time_for_an_array_of_items(): void
    {
        $this->stash->put('extendable', 'tape measure', 1);
    ...
    public function test_it_can_forget_an_item(): void
    {
    ...
    public function test_it_returns_false_when_forgetting_a_nonexistent_item(): void
    {
        $this->assertFalse($this->stash->forget('nonexistant-item'));
    }

    public function test_it_can_forget_an_array_of_items(): void
    {
    ...
    public function test_it_is_flushable(): void
    {
